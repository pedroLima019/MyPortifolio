    ...
    <main className="flex flex-col items-center justify-center p-6 w-full gap-1 sm:gap-10 ">
      ...
      <section className="flex flex-col w-full items-center justify-center gap-10 p-2 sm:flex-row lg:gap-2 lg:p-5 2xl:gap-0 2xl:p-10">
        <div className="flex flex-col justify-center items-center gap-5 w-full lg:gap-5 xl:gap-10 ">
          <p className="text-justify text-white font-light text-sm lg:text-lg xl:text-2xl 2xl:leading-10">
          ...
          <div className="flex justify-center text-white gap-5 2xl:gap-10 lg:gap-8">
            ...
            >
              {" "}
              <MdEmail className="w-[25px] h-[25px] 2xl:w-[40px] 2xl:h-[40px] lg:w-[35px] lg:h-[35px] " />
            </a>
            <a
              href="http://"
              target="_blank"
            ...
            >
              {" "}
              <BsWhatsapp className="w-[25px] h-[25px] 2xl:w-[40px] 2xl:h-[40px] lg:w-[35px] lg:h-[35px]" />
            </a>
            <a
              href="http://"
              target="_blank"
            ...
            >
              {" "}
              <CiLinkedin className="w-[27px] h-[27px] 2xl:w-[42px] 2xl:h-[42px] lg:w-[35px] lg:h-[35px]" />
            </a>
            <a
              href="http://"
              target="_blank"
              ...
              className="hover:text-indigo-600 transition-all duration-300"
            >
              <BsGithub className="w-[25px] h-[25px] 2xl:w-[40px] 2xl:h-[40px] lg:w-[35px] lg:h-[35px]" />
            </a>
          </div>
        </div>
        <div className="w-full flex justify-center items-center">
          <img
            src="/PedroFoto.png"
            alt="Foto Pedro Lima "
            className="bg-indigo-600 rounded-full w-[250px] lg:w-[400px] xl:w-[500px]"
          />
        </div>
      </section>
    </main>
